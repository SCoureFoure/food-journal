...
final _kMeals = [
  ...
  _M(
    ...
    [
      ...
      _I(
        'Sautéed mushrooms',
        portion: '~5-6 oz',
        prep: 'Sliced cremini, olive oil, salt, pepper, mustard seed',
        calories: 100,
        protein: 4,
        carbs: 5,
        fat: 7,
  ...
  _M(
    ...
    [
      _I(
        'Smoothie bowl',
        portion: '~2 cups',
        prep: 'Banana, spinach, almond milk, vanilla protein powder blended. Topped with granola, sliced banana, chia seeds.',
        calories: 420,
        protein: 28,
        carbs: 52,
        fat: 9,
        reaction: ReactionLevel.none,
        ingredients: ['banana', 'spinach', 'almond milk', 'vanilla protein powder', 'granola', 'chia seeds'],
      ),
    ],
  ),
  _M(
    ...
    [
      _I(
        ...
        fat: 12,
        reaction: ReactionLevel.mild,
        notes: 'Broth discarded — sodium significantly lower than label. Slight lower abdomen bloating at 1am, likely normal digestion from earlier meals.',
  ...
  _M(
    ...
    [
      _I(
        'Everything bagel',
        portion: '1 large bagel',
        prep: 'Cream cheese, smoked salmon, capers, thinly sliced red onion',
        calories: 510,
        protein: 26,
        carbs: 58,
        fat: 19,
      ...
      _I(
        'Cold brew coffee',
        portion: '12 oz',
        prep: 'With a splash of oat milk',
        calories: 40,
        protein: 1,
        carbs: 6,
        fat: 1,
        reaction: ReactionLevel.pending,
        ingredients: ['cold brew concentrate', 'oat milk'],
      ),
    ],
  ),
  _M(
    ...
    [
      _I(
        'Red lentil soup',
        portion: '~2 cups',
        prep: 'Homemade — red lentils, carrots, celery, cumin, turmeric, lemon',
        calories: 340,
        protein: 18,
        carbs: 52,
        fat: 5,
        reaction: ReactionLevel.pending,
        ingredients: ['red lentils', 'carrots', 'celery', 'onion', 'garlic', 'cumin', 'turmeric', 'vegetable broth', 'lemon'],
      ),
      _I(
        'Crusty bread',
        portion: '2 slices (~2.5 oz)',
        prep: 'Plain, lightly toasted',
        calories: 160,
        protein: 5,
        carbs: 30,
        fat: 2,
        reaction: ReactionLevel.pending,
        ingredients: ['white bread flour', 'water', 'yeast', 'salt'],
      ),
    ],
  ),
];
